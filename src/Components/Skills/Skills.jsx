...
export default function Skills({title}) {
  const list=[{img:img1},{img:img2},{img:img3},{img:img4},{img:img5},{img:img6},{img:img7},{img:img8},{img:img9},{img:img10}]
  ...
  return (
    <>
    {isLoading?<Loading/>:<>  <section id={`${styles.skills}`} className='d-flex align-items-center '>
    <TopNav title={'Skills'}/>
     <div className="container">
        <div className={`${styles.skillsItem} row d-flex  align-items-center text-center`} data-aos="zoom-in">
